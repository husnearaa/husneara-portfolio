        ...
        <div className="bg-[#0f2c44]">
            <div className="max-w-6xl mx-auto py-10 px-3 md:py-10 md:px-6 lg:py-20 lg:px-0 ">
                <div className="text-center my-10 space-y-2">
                    <h2 className="md:text-5xl text-2xl text-white font-extrabold text-center">My <span className="md:text-5xl text-2xl text-[#01a1e5] font-extrabold">Skills</span></h2>
                </div>
